...
public class DisassemblyManager {
    ...
    public static WeaponSprite importDisassembly(String palettesPath, String graphicsPath){
        ...
        try{
            ...
            if(palettespath.toFile().exists() && graphicspath.toFile().exists()){
                ...
                palettes = new Color[paletteData.length/4][];
                for(int i=0;i<paletteData.length/4;i++){
                    basePaletteData[2] = 0xE;
                    basePaletteData[3] = (byte)0xEE;
                    basePaletteData[4] = 0;
                    basePaletteData[5] = 0;
                    basePaletteData[28] = paletteData[i*4];
                    basePaletteData[29] = paletteData[i*4+1];
                    basePaletteData[30] = paletteData[i*4+2];
                    basePaletteData[31] = paletteData[i*4+3];
